...
int main()
{
	...
	src = "You will also need to ensure that yonu use your compiler in a C99-compatible mode (for example, using the -std=gnu99 option to gcc). Also shadaa";
	ft_print_memory((void *)src, 144);
	// char    dst[10] = "shahir    ";
	// char	dstr[10] = "shahir    ";
	// dst[5] = 's';
	// dstr[5] = 's';
