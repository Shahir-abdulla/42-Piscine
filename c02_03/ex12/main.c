...
int main()
{
	unsigned char src[] = "You will also need to ensure that yonu use your compiler\nin a C99-compatible mode (for example, using the -std=gnu99 option to gcc). Also shad kdafjks;dlaf sa;dlfjasd;kfj adlsfksfad;lkf";

	src[2] = 200;
	ft_print_memory((void *)src, 150);
	// char    dst[10] = "shahir    ";
	// char	dstr[10] = "shahir    ";
	// dst[5] = 's';
	// dstr[5] = 's';
